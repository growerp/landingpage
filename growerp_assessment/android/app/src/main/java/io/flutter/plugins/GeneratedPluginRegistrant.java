...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.quickbirdstudios.survey_kit.SurveyKitPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin survey_kit, com.quickbirdstudios.survey_kit.SurveyKitPlugin", e);
    }
    try {
